...
export class LastArcTechnickData extends foundry.abstract.TypeDataModel {
  ...
  prepareDerivedData() {
    ...
    /**
     * `hasNumericGrants` was computed here, and mirrored on
     * `LastArcFeatureData`. Both were read by nothing — no template, no sheet,
     * no rule — for as long as they had existed.
     *
     * The label its comment promised now exists: the item sheet asks
     ...
     * drifted — this one never counted `hp`, `mp` or `dr`, and neither counted
     * a granted reroll — which is what an unread derived value does.
     */
  }
}
